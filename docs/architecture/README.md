...
- [Startup Flow & Inter-Module Communication](startup-flow-and-communication.md): Startup sequence, message bus architecture, plugin loading order, and end-to-end communication patterns
